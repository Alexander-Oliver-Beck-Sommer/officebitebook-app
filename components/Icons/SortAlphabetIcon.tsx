type SortAlphabetIconProps = {
  className?: string;
  variant?: "alphabet-ascending" | "alphabet-descending";
};

const SortAlphabetIcon = ({
  className = "",
  variant = "alphabet-ascending",
}: SortAlphabetIconProps) => {
  return (
    <>
      {variant === "alphabet-ascending" ? (
        <svg
...
export default SortAlphabetIcon;
